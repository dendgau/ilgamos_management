            ...
            <table class="table table-contract" style="margin-bottom: 20px;">
                ...
                <tr>
                    ...
                    <td class="child" style="border-top: 1px dotted black; border-right: 1px dotted black;">
                        {!!  Form::text('product_name_vi', old('product_name_vi'), ['class' => 'form-control', 'placeholder' => 'Nhập tên sản phẩm (Tiếng Việt)']) !!}
                ...
                <tr>
                    ...
                    <td class="child" style="border-right: 1px dotted black;">
                        {!!  Form::text('product_name_en', old('product_name_en'), ['class' => 'form-control', 'placeholder' => 'Nhập tên sản phẩm (Tiếng Anh)']) !!}
