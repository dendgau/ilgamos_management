            ...
            <table class="table table-contract" style="margin-bottom: 20px;">
                <tr>
                    <th class="head1" rowspan="5" style="border-top: 1px dotted black;">
                        Số sản phẩm: <a href="{{Request::url()}}">SP00{{$product->id}}</a>
                    </th>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="head2" style="bborder-left: 1px dotted #adadad;">Loại sản phẩm</th>
                    <td class="child" style="border-right: 1px dotted black;">
                        {!!  Form::select('product_type', $product_type, count($errors->all()) > 0 ? old('product_type') : $product->product_type, ['class' => 'form-control', 'style' => 'width: 300px']) !!}
                ...
                <tr>
                    ...
                    <td class="child" style="border-right: 1px dotted black;">
                        {!!  Form::input('number', 'price', count($errors->all()) > 0 ? old('price') : $product_detail->price, ['class' => 'form-control', 'style' => 'width: 300px']) !!}
